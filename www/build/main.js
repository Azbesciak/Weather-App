...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_weather_weather__ = __webpack_require__(265);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = (function () {
    ...
    HomePage.prototype.ionViewWillEnter = function () {
        ...
        this.weatherProvider
            .getWeather()
            .then(function (weather) { return _this.weather = weather.current_observation; });
    };
    return HomePage;
}());
HomePage = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__providers_weather_weather__["a" /* WeatherProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_weather_weather__["a" /* WeatherProvider */]) === "function" && _b || Object])
], HomePage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_settings_settings__ = __webpack_require__(98);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__providers_weather_weather__ = __webpack_require__(265);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__angular_http__ = __webpack_require__(266);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_storage__ = __webpack_require__(269);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__providers_location_location__ = __webpack_require__(274);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        ...
        providers: [
            ...
            __WEBPACK_IMPORTED_MODULE_14__providers_location_location__["a" /* LocationProvider */]
        ]
    })
], AppModule);
...
ContactPage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-contact',template:/*ion-inline-start:"C:\Projects\iweather\src\pages\contact\contact.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Contact\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list>\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n    <ion-item>\n      <ion-icon name="ionic" item-left></ion-icon>\n      @ionicframework\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Projects\iweather\src\pages\contact\contact.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]])
], ContactPage);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__location_location__ = __webpack_require__(274);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var WeatherProvider = (function () {
    function WeatherProvider(http, locationProvider) {
        this.http = http;
        this.locationProvider = locationProvider;
        this.apiKey = "ac74811bf3cddfee";
        this.url = this.prepareBasicUrl();
    }
    WeatherProvider.prototype.prepareBasicUrl = function () {
    ...
    WeatherProvider.prototype.getWeather = function () {
        ...
        return this.locationProvider.location
            .then(function (location) { return _this.http.get(_this.getUrlForCity(location))
            .map(function (res) { return res.json(); })
            .toPromise(); });
    };
    WeatherProvider.prototype.getUrlForCity = function (location) {
...
WeatherProvider = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__location_location__["a" /* LocationProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__location_location__["a" /* LocationProvider */]) === "function" && _b || Object])
], WeatherProvider);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ionic_storage__ = __webpack_require__(269);
...
var LocationProvider = (function () {
    function LocationProvider(storage) {
        ...
        this.LOCATION_KEY = "_location";
    }
    Object.defineProperty(LocationProvider.prototype, "location", {
        get: function () {
            var _this = this;
            if (Object(__WEBPACK_IMPORTED_MODULE_2_ionic_angular_util_util__["p" /* isUndefined */])(this._location)) {
                return this.initLocation().then(function () { return _this._location; });
            }
    ...
    LocationProvider.prototype.initLocation = function () {
        var _this = this;
        return this.storage.get(this.LOCATION_KEY)
            ...
            if (location != null) {
                ...
                _this._location = new Location("San_Francisco", null, "CA");
                _this.saveLocation(_this._location);
            }
        });
    };
    LocationProvider.prototype.saveLocation = function (location) {
...
var Location = (function () {
    function Location(city, country, state) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_location_location__ = __webpack_require__(274);
...
var SettingsPage = (function () {
    function SettingsPage(navCtrl, navParams, locationProvider) {
        var _this = this;
        this.navCtrl = navCtrl;
    ...
    SettingsPage.prototype.saveForm = function () {
        ...
        this.navCtrl.insert(0, __WEBPACK_IMPORTED_MODULE_3__home_home__["a" /* HomePage */]).then(function () { return _this.navCtrl.pop(); });
    };
    return SettingsPage;
}());
SettingsPage = __decorate([
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'page-settings',template:/*ion-inline-start:"C:\Projects\iweather\src\pages\settings\settings.html"*/'<!--\n  Generated template for the SettingsPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>Settings</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <ion-grid>\n    <ion-row>\n      <ion-col width-150>\n        <ion-list>\n          <form (ngSubmit)="saveForm()">\n            <ion-item>\n              <ion-label fixed>\n                City\n              </ion-label>\n              <ion-input [(ngModel)]="location.city" name="city" type="text"></ion-input>\n            </ion-item>\n            <ion-item>\n              <ion-label fixed>\n                State\n              </ion-label>\n              <ion-input [(ngModel)]="location.state" name="state" type="text"></ion-input>\n            </ion-item>\n            <button ion-button block>Save Changes</button>\n          </form>\n        </ion-list>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"C:\Projects\iweather\src\pages\settings\settings.html"*/,
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* NavParams */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__providers_location_location__["a" /* LocationProvider */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__providers_location_location__["a" /* LocationProvider */]) === "function" && _c || Object])
], SettingsPage);
